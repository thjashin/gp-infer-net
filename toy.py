...
tf.flags.DEFINE_string("method", "fbnn", """Inference algorithm.""")
tf.flags.DEFINE_integer("batch_size", 20, """Total batch size.""")
tf.flags.DEFINE_integer("m", 5, """Measurement set size.""")
...
tf.flags.DEFINE_bool("pretrain", True, """Iters of pretraining GP priors.""")
